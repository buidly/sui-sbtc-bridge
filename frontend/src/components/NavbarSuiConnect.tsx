...
import { formatBalance, formatTrimmed, getExplorerUrlAddress } from "@/lib/helpers";
...
function NavbarSuiConnect() {
  ...
  return (
    <div className="flex items-center bg-slate-50/5 border border-slate-700 rounded-full px-4 py-2 shadow-lg backdrop-blur-sm">
      <a href={getExplorerUrlAddress("SUI", suiAddress)} target="_blank" className="text-slate-300 text-sm mr-2">
        {formatTrimmed(suiAddress, 8)}
      </a>
